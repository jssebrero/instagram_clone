...
<?php 
    ...
    <div class="container w-25">
        <h2>Home <?= $this -> data['user'] -> getUserName() ?></h2> </h2>

        
        <?php 
            require_once 'src/components/create.php';
        ?>
        ...
        <?php 
            ...
            <div class="card mt-2">
                    ...
                    <a class="link-dark" href="profile/<?php echo $p->getUser()->getUsername() ?>"><?php echo $p->getUser()->getUsername() ?></a>
